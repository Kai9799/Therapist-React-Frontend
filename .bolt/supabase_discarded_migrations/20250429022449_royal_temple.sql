/*
  ...
  1. New Tables
    - users
      - Core user profile and subscription data
      - Organization membership tracking
      - Subscription and billing info
    - organizations  
      - Organization/team management
      - Seat tracking and billing
      - Trial period handling

  2. Security
    - RLS enabled on all tables
    - Policies for user access control
    - Secure functions for org management

  3. Functions
    - create_organization: Creates new org and updates owner
    - join_organization: Handles member joining via invite code
*/

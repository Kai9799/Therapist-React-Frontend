...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Therapists can manage own session notes" ON session_notes;
  DROP POLICY IF EXISTS "Therapists can manage own resources" ON resources;
  DROP POLICY IF EXISTS "Therapists can manage own stats" ON activity_stats;
...
DO $$ BEGIN
  ...
  DROP TRIGGER IF EXISTS ensure_therapist_stats ON therapists;
  DROP TRIGGER IF EXISTS increment_session_plans_stats ON session_plans;
  DROP TRIGGER IF EXISTS increment_resources_stats ON resources;
EXCEPTION WHEN undefined_object THEN NULL;
END $$;
